...
#plt.plot(x_out[:N], label='Filtered X')
#plt.plot(x_data[:N], label='Original X')

#plt.plot(y_out[:N], label='Filtered Y')
#plt.plot(y_data[:N], label='Original Y')

#plt.plot(z_out[:N], label='Filtered Z')
#plt.plot(z_data[:N], label='Original Z')
plt.legend()
...
plt.legend()
plt.ylabel('Value')
plt.title('Gravity Comparison (First {} samples)'.format(N))
